...
`;function P({annotation:e,className:t=``,style:n=k,active:r}){let{geometry:i}=e;return i?(0,u.jsx)(N,{className:t,style:{position:`absolute`,left:`${i.x}%`,top:`${i.y}%`,height:`${i.height}%`,width:`${i.width}%`,boxShadow:r?`0 0 1px 1px yellow inset`:void 0,...n}}):null}var le=l.default.div`
  border: dashed 2px black;
  border-radius: 100%;
  box-shadow: 0px 0px 1px 1px white inset;
  box-sizing: border-box;
  transition: box-shadow 0.21s ease-in-out;
`;function F({annotation:e,className:t=``,style:n=k,active:r}){let{geometry:i}=e;return i?(0,u.jsx)(le,{className:t,style:{position:`absolute`,left:`${i.x}%`,top:`${i.y}%`,height:`${i.height}%`,width:`${i.width}%`,boxShadow:r?`0 0 1px 1px yellow inset`:void 0,...n}}):null}var I=l.default.div`
  background: white;
  border-radius: 2px;
  box-shadow:
    0px 1px 5px 0px rgba(0, 0, 0, 0.2),
  ...
  margin-left: 8px;
  pointer-events: auto;
`;function L({annotation:e,style:t=k,className:n=``}){let{geometry:r}=e;return!r||r.x===void 0||r.y===void 0||r.width===void 0||r.height===void 0?null:(0,u.jsx)(I,{style:{position:`absolute`,left:`${r.x}%`,top:`${r.y+r.height}%`,...t},className:n,children:e.data&&e.data.text})}var R=l.default.div`
...
`,U=(0,l.default)(V)`
  ...
  color: #0f0f0f;
  flex-shrink: 0;
`,W=({annotationId:e,onRemove:t,disabled:n,className:r,style:i})=>(0,u.jsx)(H,{type:`button`,className:r,style:i,onClick:r=>{r.stopPropagation(),!n&&t(e)},disabled:n,"aria-label":`Remove annotation`,$disabled:n,"data-testid":`annotation-delete-button`,children:(0,u.jsx)(U,{})});function de(e){return!e||typeof e.x!=`number`||typeof e.y!=`number`||typeof e.width!=`number`?null:{left:`calc(${e.x}% + ${e.width}%)`,top:`calc(${e.y}%)`,transform:`translate(-50%, -50%)`}}var fe={position:`absolute`,top:0,right:0,transform:`translate(50%, -50%)`,width:44,height:44,display:`flex`,alignItems:`center`,justifyContent:`center`,pointerEvents:`auto`,zIndex:20},pe=l.default.div`
  position: absolute;
  bottom: -25px;
  right: 0;
  display: flex;
...
`,me=({onConfirm:e,onReset:t})=>(0,u.jsxs)(pe,{onMouseDown:e=>e.stopPropagation(),children:[(0,u.jsx)(G,{type:`button`,onClick:t=>{t.stopPropagation(),e()},children:`✓`}),(0,u.jsx)(G,{type:`button`,onClick:e=>{e.stopPropagation(),t()},children:`✕`})]}),he=l.default.div`
  position: absolute;
  width: 10px;
  height: 10px;
  background-color: white;
...
`,ge=l.default.div`
  ...
  z-index: 15;
  pointer-events: auto;
`,K=({position:e,onDragStart:t,onDrag:n,onDragEnd:r,annotationId:i})=>(0,u.jsx)(he,{$position:e,onMouseDown:a=>{a.preventDefault(),a.stopPropagation();let o={x:a.clientX,y:a.clientY};t(i,o);let s=t=>{n(t,e,o)},c=()=>{document.removeEventListener(`mousemove`,s),document.removeEventListener(`mouseup`,c),r?.()};document.addEventListener(`mousemove`,s),document.addEventListener(`mouseup`,c)},onClick:e=>e.stopPropagation(),"data-type":`dot`}),_e=({onMoveStart:e,onMove:t,onMoveEnd:n,annotationId:r})=>(0,u.jsx)(ge,{onMouseDown:i=>{i.preventDefault(),i.stopPropagation();let a={x:i.clientX,y:i.clientY};e(r,a);let o=e=>{t(e,a)},s=()=>{document.removeEventListener(`mousemove`,o),document.removeEventListener(`mouseup`,s),n?.()};document.addEventListener(`mousemove`,o),document.addEventListener(`mouseup`,s)},onClick:e=>e.stopPropagation(),"data-type":`move-button`,children:(0,u.jsx)(ue,{})}),ve=l.default.div`
  position: absolute;
  border: none;
...
`,ye=({annotation:e,isDragging:t,hasPendingChanges:n,onDotDragStart:r,onDotDrag:i,onMoveStart:a,onMove:o,onDragEnd:s,enableRemoval:l,onRemoveAnnotation:d,onConfirm:f,onReset:p,onDeleteControlMouseEnter:m,onDeleteControlMouseLeave:h})=>{let{geometry:g}=e,_=e.data?.id,v=(0,c.useRef)(null),y=(t||n)&&f&&p;if((0,c.useEffect)(()=>{if(t||n||!p||_==null)return;let e=e=>{let t=v.current;if(!t)return;let n=t.getBoundingClientRect(),{clientX:r,clientY:i}=e;(r<n.left||r>n.right||i<n.top||i>n.bottom)&&p(_)};return document.addEventListener(`mousemove`,e),()=>{document.removeEventListener(`mousemove`,e)}},[t,n,p,_]),!g||typeof g.x!=`number`||typeof g.y!=`number`||typeof g.width!=`number`||typeof g.height!=`number`)return null;let b=String(_??``);return(0,u.jsxs)(ve,{ref:v,className:`rectangle-editor-box`,style:{left:`${g.x}%`,top:`${g.y}%`,width:`${g.width}%`,height:`${g.height}%`},"data-annotation-draggable-box":!0,children:[(0,u.jsx)(K,{position:`top`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:b}),(0,u.jsx)(K,{position:`right`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:b}),(0,u.jsx)(K,{position:`bottom`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:b}),(0,u.jsx)(K,{position:`left`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:b}),(0,u.jsx)(_e,{onMoveStart:a,onMove:o,onMoveEnd:s,annotationId:b}),l&&d&&_!=null&&(0,u.jsx)(`div`,{style:fe,onMouseEnter:()=>m?.(_),onMouseLeave:()=>h?.(),onPointerEnter:()=>m?.(_),onPointerLeave:()=>h?.(),children:(0,u.jsx)(W,{annotationId:_,onRemove:d})}),y&&(0,u.jsx)(me,{onConfirm:()=>f(_),onReset:()=>p(_)})]})},be=`RECTANGLE`;function xe({x:e,y:t},n,r){if(!n)return!1;let i=Math.min(n.x,n.x+n.width),a=Math.max(n.x,n.x+n.width),o=Math.min(n.y,n.y+n.height),s=Math.max(n.y,n.y+n.height);return!(e<i||t<o||e>a||t>s)}function q(e,t){return!e||e.width<=0||e.height<=0?0:Math.abs(e.width)*Math.abs(e.height)}var Se={onTouchStart(e,t){return Ce(e,t)},onTouchEnd(e,t){return we(e,t)},onTouchMove(e,t){return J(e,t)},onMouseDown(e,t){return Ce(e,t)},onMouseUp(e,t){return we(e,t)},onMouseMove(e,t){return J(e,t)}};function Ce(e,t){if(e.selection)return{};{let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}}function we(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function J(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:be,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var Y={TYPE:be,intersects:xe,area:q,methods:Se},Te=6,Ee=(e={width:100,height:100})=>({marginX:Te/e.width*100,marginY:Te/e.height*100}),De=`POINT`;function Oe({x:e,y:t},n,r){if(!n)return!1;let{marginX:i,marginY:a}=Ee(r),o=Math.min(i,a)/2,s=Math.abs(e-n.x),c=Math.abs(t-n.y);return s<=o&&c<=o}function ke(e,t){return 0}var X={TYPE:De,intersects:Oe,area:ke,methods:{onClick(e,t){return e.geometry?{}:{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`},geometry:{...e.geometry,...m(t),width:0,height:0,type:De}}}}},Z=e=>e**2,Ae=`OVAL`;function je({x:e,y:t},n,r){if(!n||!n.width||!n.height)return!1;let i=Math.abs(n.width),a=Math.abs(n.height),o={x:n.x+i/2,y:n.y+a/2},s=i/2,c=a/2;if(s===0||c===0)return!1;let l=e-o.x,u=t-o.y;return Z(l)/Z(s)+Z(u)/Z(c)<=1}function Me(e,t){if(!e||e.width<=0||e.height<=0)return 0;let n=Math.abs(e.width),r=Math.abs(e.height);return n/2*Math.PI*(r/2)}var Ne={onTouchStart(e,t){return Pe(e,t)},onTouchEnd(e,t){return Fe(e,t)},onTouchMove(e,t){return Ie(e,t)},onMouseDown(e,t){if(!e.geometry){let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e},onMouseUp(e,t){if(e.selection&&e.selection.mode===`SELECTING`)return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}}},onMouseMove(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t);return{...e,geometry:{...e.geometry,type:Ae,x:Math.min(n,i),y:Math.min(r,a),width:Math.abs(i-n),height:Math.abs(a-r)}}}return e}};function Pe(e,t){if(e.selection)return{};{let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e}function Fe(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function Ie(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:Ae,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var Q={TYPE:Ae,intersects:je,area:Me,methods:Ne},$={disableAnnotation:!1,disableSelector:!1,disableEditor:!1,disableOverlay:!1,disableContent:!1,disableHitTesting:!1,allowTouch:!1,type:Y.TYPE,selectors:[Y,X,Q],activeAnnotationComparator:(e,t)=>e===t,enableEditing:!1,onAnnotationsChange:()=>{process.env.NODE_ENV!==`production`&&console.warn(`onAnnotationsChange not provided. Annotation editing will not persist changes. Please provide an onAnnotationsChange prop to handle annotation updates.`)},renderSelector:({annotation:e})=>{switch(e.geometry?.type){case Y.TYPE:return(0,u.jsx)(M,{annotation:e});case X.TYPE:return(0,u.jsx)(E,{annotation:e});case Q.TYPE:return(0,u.jsx)(F,{annotation:e});default:return null}},renderEditor:({annotation:e,onChange:t,onSubmit:n})=>(0,u.jsx)(se,{annotation:e,onChange:t,onSubmit:n}),renderHighlight:({key:e,annotation:t,active:n})=>{switch(t.geometry.type){case Y.TYPE:return(0,u.jsx)(P,{annotation:t,active:n},e);case X.TYPE:return(0,u.jsx)(E,{annotation:t},e);case Q.TYPE:return(0,u.jsx)(F,{annotation:t,active:n},e);default:return null}},renderContent:({key:e,annotation:t})=>(0,u.jsx)(L,{annotation:t},e),renderOverlay:({type:e,annotation:t}=ie)=>{switch(e){case X.TYPE:return(0,u.jsx)(R,{children:`Click to Annotate`});default:return(0,u.jsx)(R,{children:`Click and Drag to Annotate`})}},renderDraggableHighlight:({key:e,annotation:t,active:n,isHovered:r,isDragging:i,hasPendingChanges:a,onDotDragStart:o,onDotDrag:s,onMoveStart:c,onMove:l,onDragEnd:d,enableRemoval:f,onRemoveAnnotation:p,onConfirm:m,onReset:h,onDeleteControlMouseEnter:g,onDeleteControlMouseLeave:_})=>{if(!r&&!i&&!a)switch(t.geometry.type){case Y.TYPE:return(0,u.jsx)(P,{annotation:t,active:n},e);case X.TYPE:return(0,u.jsx)(E,{annotation:t},e);case Q.TYPE:return(0,u.jsx)(F,{annotation:t,active:n},e);default:return null}if(t.geometry.type===Y.TYPE)return(0,u.jsx)(ye,{annotation:t,active:n,isHovered:r,isDragging:i,hasPendingChanges:a,onDotDragStart:o,onDotDrag:s,onMoveStart:c,onMove:l,onDragEnd:d,enableRemoval:f,onRemoveAnnotation:p,onConfirm:m,onReset:h,onDeleteControlMouseEnter:g,onDeleteControlMouseLeave:_},`${e}-editor`);switch(t.geometry.type){case X.TYPE:return(0,u.jsx)(E,{annotation:t},e);case Q.TYPE:return(0,u.jsx)(F,{annotation:t,active:n},e);default:return null}}},Le=l.default.div`
  ...
  align-items: center;
  justify-content: center;
`;function Re({annotation:e,onRemove:t,renderDelete:n,disabled:r,onDeleteControlMouseEnter:i,onDeleteControlMouseLeave:a}){let[o,s]=(0,c.useState)(!1),l=e.data?.id,d=de(e.geometry),f=r||o,p=(0,c.useCallback)(async()=>{if(!(f||l==null)){s(!0);try{await t(l)}finally{s(!1)}}},[l,f,t]),m=(0,c.useCallback)(()=>{l!=null&&i?.(l)},[l,i]),h=(0,c.useCallback)(()=>{a?.()},[a]);if(!d||l==null)return null;let g={onMouseEnter:m,onMouseLeave:h,onPointerEnter:m,onPointerLeave:h};return n?(0,u.jsx)(Le,{style:d,...g,children:n({key:l,annotation:e,active:!0,onRemove:p,disabled:f})}):(0,u.jsx)(Le,{style:d,className:`annotation-delete`,...g,children:(0,u.jsx)(W,{annotationId:l,onRemove:p,disabled:f})})}var ze=l.default.div`
  clear: both;
  position: relative;
  width: 100%;
...
`,Ue=l.default.div`
  ...
  z-index: 20;
  pointer-events: none;
`;function We({annotationId:e,annotation:t,active:n,slot:r}){return(0,u.jsx)(u.Fragment,{children:r({key:e,annotation:t,active:n})})}function Ge({annotationId:e,annotation:t,slot:n}){return(0,u.jsx)(u.Fragment,{children:n({key:e,annotation:t})})}function Ke({enableRemoval:e,onRemoveAnnotation:t,isActive:n,annotation:r,canRemoveAnnotation:i,enableEditing:a,draggableHighlightSlot:o,isHovered:s}){return!e||!t||!n||i&&!i(r)?!1:!(a&&o&&s&&r.geometry?.type===Y.TYPE)}function qe({setContainerRef:e,style:t,className:n,onContainerMouseLeave:r,onContainerTouchCancel:i,onContainerMouseMove:a,setImageRef:o,src:s,alt:l,annotations:d,renderSlots:f,layoutOptions:p,annotationState:m,value:h,setTargetRef:g,onInteractionTargetClick:_,onInteractionTargetMouseUp:v,onInteractionTargetMouseDown:y,effectiveType:b,onChange:x,onEditorSubmit:S,onImageLoad:C,onImageError:ee,children:te}){let{renderHighlight:w,renderDraggableHighlight:T,renderSelector:ne,renderOverlay:E,renderContent:D,renderEditor:O,renderDelete:re}=f,{touchEnabled:k,selectorDisabled:ie,overlayDisabled:ae,editorDisabled:A,contentDisabled:oe,hitTestingDisabled:se,enableEditing:j}=p,{getIsActive:ce,topAnnotation:M,editModeIds:N,isDragging:P,draggingAnnotationId:le,hasPendingChanges:F,getEffectiveAnnotation:I,draggingHandlers:L,onConfirm:R,onReset:ue,enableRemoval:z,onRemoveAnnotation:B,canRemoveAnnotation:V,onDeleteControlMouseEnter:H,onDeleteControlMouseLeave:U}=m;return(0,u.jsxs)(ze,{ref:e,style:t,className:n,onMouseLeave:r,onTouchCancel:i,onMouseMove:a,$allowTouch:k,children:[(0,u.jsx)(Be,{ref:o,src:s,alt:l,onLoad:C,onError:ee}),(0,u.jsxs)(Ve,{children:[d.map(e=>{let t=e.data?.id;if(!t)return null;let n=ce(e,M),r=M?.data?.id===t,i=P&&le===t,a=!!F?.(t),o=I?I(e):e,s=j&&T&&L&&(r||i||a)?e=>(0,u.jsxs)(c.default.Fragment,{children:[w?w(e):null,T({...e,annotation:o,isHovered:r,isDragging:!!i,hasPendingChanges:a,...L,enableRemoval:z,onRemoveAnnotation:B,onConfirm:R,onReset:ue,onDeleteControlMouseEnter:H,onDeleteControlMouseLeave:U})]}):w;return s?(0,u.jsx)(We,{annotationId:t,annotation:o,active:n,slot:s},t):null}),!ie&&h?.geometry&&ne&&ne({annotation:h})]}),(0,u.jsx)(He,{ref:g,"data-testid":`annotation-target`,$hitTestingDisabled:se,onClick:_,onMouseUp:v,onMouseDown:y}),!ae&&E&&E({type:b,annotation:h}),(0,u.jsxs)(Ue,{children:[d.map(e=>{let t=e.data?.id;if(!t)return null;let n=N?.includes(t)||!1,r=ce(e,M),i=M?.data?.id===t,a=!oe&&(r||n)&&D!=null,o=Ke({enableRemoval:z,onRemoveAnnotation:B,isActive:r,annotation:e,canRemoveAnnotation:V,enableEditing:j,draggableHighlightSlot:T,isHovered:i});return!a&&!o?null:(0,u.jsxs)(c.default.Fragment,{children:[a?(0,u.jsx)(Ge,{annotationId:t,annotation:e,slot:D}):null,o&&B?(0,u.jsx)(Re,{annotation:e,onRemove:B,renderDelete:re,onDeleteControlMouseEnter:H,onDeleteControlMouseLeave:U}):null]},t)}),!A&&h?.selection?.showEditor&&O&&x&&O({annotation:h,onChange:x,onSubmit:S})]}),te]})}function Je({ref:e,...t}){let{children:n,...r}=(0,c.useMemo)(()=>{let{renderSlots:e,...n}=t;return{...$,...n,selectors:n.selectors??$.selectors,renderSelector:n.renderSelector??e?.renderSelector??$.renderSelector,renderEditor:n.renderEditor??e?.renderEditor??$.renderEditor,renderHighlight:n.renderHighlight??e?.renderHighlight??$.renderHighlight,renderContent:n.renderContent??e?.renderContent??$.renderContent,renderOverlay:n.renderOverlay??e?.renderOverlay??$.renderOverlay,renderDraggableHighlight:n.renderDraggableHighlight??e?.renderDraggableHighlight??$.renderDraggableHighlight}},[t]);return(0,u.jsx)(qe,{...T(r,e),children:n})}Je.displayName=`Annotation`;function Ye(e,t){if(!e||typeof e.getBoundingClientRect!=`function`)return!1;let{pageX:n,pageY:r}=t,{left:i,right:a,bottom:o,top:s}=e.getBoundingClientRect();return n>i&&n<a&&r>s&&r<o}function Xe(){let[e,t]=(0,c.useState)(!1),n=(0,c.useRef)(null);return(0,c.useEffect)(()=>{let e=e=>{let r=n.current;t(Ye(r,{pageX:e.pageX,pageY:e.pageY}))};return document.addEventListener(`mousemove`,e,{passive:!0}),()=>{document.removeEventListener(`mousemove`,e)}},[]),{isHoveringOver:e,setRef:(0,c.useCallback)(e=>{n.current=e},[])}}var Ze=Je;exports.Annotation=Je,exports.AnnotationDeleteControl=Re,exports.ConfirmResetButtons=me,exports.DELETE_BUTTON_HIT_AREA_PX=B,exports.DELETE_BUTTON_SIZE_PX=z,exports.DeleteButton=W,exports.DeleteCrossIcon=V,exports.DraggableBox=ye,exports.DraggableDot=K,exports.MoveButton=_e,exports.OvalSelector=Q,exports.PointSelector=X,exports.RectangleSelector=Y,exports.default=Ze,exports.deleteCornerBoxStyle=fe,exports.getDeleteCornerPosition=de,exports.useAnnotationHitDetection=y,exports.useDragging=ee,exports.useMouseHover=Xe,exports.useRelativeMousePosition=v,exports.useSelectorMethods=x;