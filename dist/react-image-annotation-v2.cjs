...
`,Ce=({onConfirm:e,onReset:t})=>(0,u.jsxs)(Se,{onMouseDown:e=>e.stopPropagation(),children:[(0,u.jsx)(V,{type:`button`,onClick:t=>{t.stopPropagation(),e()},children:`✓`}),(0,u.jsx)(V,{type:`button`,onClick:e=>{e.stopPropagation(),t()},children:`✕`})]}),we=l.default.div`
  position: absolute;
  width: 10px;
  height: 10px;
  background-color: white;
...
`,Te=l.default.div`
  ...
  z-index: 15;
  pointer-events: auto;
`,H=({position:e,onDragStart:t,onDrag:n,onDragEnd:r,annotationId:i})=>(0,u.jsx)(we,{$position:e,onMouseDown:a=>{a.preventDefault(),a.stopPropagation();let o={x:a.clientX,y:a.clientY};t(i,o);let s=t=>{n(t,e,o)},c=()=>{document.removeEventListener(`mousemove`,s),document.removeEventListener(`mouseup`,c),r?.()};document.addEventListener(`mousemove`,s),document.addEventListener(`mouseup`,c)},onClick:e=>e.stopPropagation(),"data-type":`dot`}),Ee=({onMoveStart:e,onMove:t,onMoveEnd:n,annotationId:r})=>(0,u.jsx)(Te,{onMouseDown:i=>{i.preventDefault(),i.stopPropagation();let a={x:i.clientX,y:i.clientY};e(r,a);let o=e=>{t(e,a)},s=()=>{document.removeEventListener(`mousemove`,o),document.removeEventListener(`mouseup`,s),n?.()};document.addEventListener(`mousemove`,o),document.addEventListener(`mouseup`,s)},onClick:e=>e.stopPropagation(),"data-type":`move-button`,children:(0,u.jsx)(ve,{})}),U=36,W=l.default.div`
  position: absolute;
  border: none;
  ...
  z-index: 10;
  box-sizing: border-box;
`,De=({annotation:e,isDragging:t,hasPendingChanges:n,onDotDragStart:r,onDotDrag:i,onMoveStart:a,onMove:o,onDragEnd:s,enableRemoval:l,onRemoveAnnotation:d,onConfirm:f,onReset:p,onDeleteControlMouseEnter:m,onDeleteControlMouseLeave:h,allowResetOnMouseLeave:g=!0})=>{let{geometry:_}=e,v=e.data?.id,y=(0,c.useRef)(null),b=(t||n)&&f&&p;if((0,c.useEffect)(()=>{if(!g||t||n||!p||v==null)return;let e=e=>{let t=y.current;if(!t)return;let n=t.getBoundingClientRect(),{clientX:r,clientY:i}=e,a=U;(r<n.left-a||r>n.right+a||i<n.top-a||i>n.bottom+a)&&p(v)};return document.addEventListener(`mousemove`,e),()=>{document.removeEventListener(`mousemove`,e)}},[g,t,n,p,v]),!_||typeof _.x!=`number`||typeof _.y!=`number`||typeof _.width!=`number`||typeof _.height!=`number`)return null;let x=String(v??``);return(0,u.jsxs)(W,{ref:y,className:`rectangle-editor-box`,style:{left:`${_.x}%`,top:`${_.y}%`,width:`${_.width}%`,height:`${_.height}%`},"data-annotation-draggable-box":!0,children:[(0,u.jsx)(H,{position:`top`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:x}),(0,u.jsx)(H,{position:`right`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:x}),(0,u.jsx)(H,{position:`bottom`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:x}),(0,u.jsx)(H,{position:`left`,onDragStart:r,onDrag:i,onDragEnd:s,annotationId:x}),(0,u.jsx)(Ee,{onMoveStart:a,onMove:o,onMoveEnd:s,annotationId:x}),l&&d&&v!=null&&(0,u.jsx)(`div`,{style:xe,onMouseEnter:()=>m?.(v),onMouseLeave:()=>h?.(),onPointerEnter:()=>m?.(v),onPointerLeave:()=>h?.(),children:(0,u.jsx)(z,{annotationId:v,onRemove:d})}),b&&(0,u.jsx)(Ce,{onConfirm:()=>f(v),onReset:()=>p(v)})]})},Oe=`RECTANGLE`;function ke({x:e,y:t},n,r){if(!n)return!1;let i=Math.min(n.x,n.x+n.width),a=Math.max(n.x,n.x+n.width),o=Math.min(n.y,n.y+n.height),s=Math.max(n.y,n.y+n.height);return!(e<i||t<o||e>a||t>s)}function Ae(e,t){return!e||e.width<=0||e.height<=0?0:Math.abs(e.width)*Math.abs(e.height)}var je={onTouchStart(e,t){return Me(e,t)},onTouchEnd(e,t){return Ne(e,t)},onTouchMove(e,t){return Pe(e,t)},onMouseDown(e,t){return Me(e,t)},onMouseUp(e,t){return Ne(e,t)},onMouseMove(e,t){return Pe(e,t)}};function Me(e,t){if(e.selection)return{};{let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}}function Ne(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function Pe(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:Oe,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var G={TYPE:Oe,intersects:ke,area:Ae,methods:je},Fe=6,Ie=(e={width:100,height:100})=>({marginX:Fe/e.width*100,marginY:Fe/e.height*100}),K=`POINT`;function Le({x:e,y:t},n,r){if(!n)return!1;let{marginX:i,marginY:a}=Ie(r),o=Math.min(i,a)/2,s=Math.abs(e-n.x),c=Math.abs(t-n.y);return s<=o&&c<=o}function Re(e,t){return 0}var q={TYPE:K,intersects:Le,area:Re,methods:{onClick(e,t){return e.geometry?{}:{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`},geometry:{...e.geometry,...m(t),width:0,height:0,type:K}}}}},J=e=>e**2,ze=`OVAL`;function Be({x:e,y:t},n,r){if(!n||!n.width||!n.height)return!1;let i=Math.abs(n.width),a=Math.abs(n.height),o={x:n.x+i/2,y:n.y+a/2},s=i/2,c=a/2;if(s===0||c===0)return!1;let l=e-o.x,u=t-o.y;return J(l)/J(s)+J(u)/J(c)<=1}function Ve(e,t){if(!e||e.width<=0||e.height<=0)return 0;let n=Math.abs(e.width),r=Math.abs(e.height);return n/2*Math.PI*(r/2)}var He={onTouchStart(e,t){return Ue(e,t)},onTouchEnd(e,t){return We(e,t)},onTouchMove(e,t){return Ge(e,t)},onMouseDown(e,t){if(!e.geometry){let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e},onMouseUp(e,t){if(e.selection&&e.selection.mode===`SELECTING`)return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}}},onMouseMove(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t);return{...e,geometry:{...e.geometry,type:ze,x:Math.min(n,i),y:Math.min(r,a),width:Math.abs(i-n),height:Math.abs(a-r)}}}return e}};function Ue(e,t){if(e.selection)return{};{let{x:n,y:r}=m(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e}function We(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function Ge(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=m(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:ze,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var Y={TYPE:ze,intersects:Be,area:Ve,methods:He},Ke=`POLYGON`,qe=3,Je=350,Ye=2;function Xe(e,t){return Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2)}function Ze(e){let t=e.map(e=>e.x),n=e.map(e=>e.y),r=Math.min(...t),i=Math.min(...n);return{x:r,y:i,width:Math.max(...t)-r,height:Math.max(...n)-i}}function Qe({x:e,y:t},n){if(!n||!n.points||n.points.length<3)return!1;let r=n.points,i=!1;for(let n=0,a=r.length-1;n<r.length;a=n++){let o=r[n].x,s=r[n].y,c=r[a].x,l=r[a].y;s>t!=l>t&&e<(c-o)*(t-s)/(l-s)+o&&(i=!i)}return i}function $e(e){if(!e||!e.points||e.points.length<3)return 0;let t=e.points,n=0;for(let e=0,r=t.length-1;e<t.length;r=e++)n+=(t[r].x+t[e].x)*(t[r].y-t[e].y);return Math.abs(n/2)}function et(e){let t=Ze(e.geometry?.points||[]);return{...e,geometry:{...e.geometry,...t},selection:{...e.selection,mode:`EDITING`,showEditor:!0,lastClickX:void 0,lastClickY:void 0,lastClickTime:void 0,cursorX:void 0,cursorY:void 0}}}var X={TYPE:Ke,intersects:Qe,area:$e,methods:{onClick(e,t){let{x:n,y:r}=m(t);if(n==null)return e;let i=e.selection?.mode,a=e.geometry?.points||[];if(i!==`COLLECTING_POINTS`)return{...e,selection:{...e.selection,mode:`COLLECTING_POINTS`,lastClickX:n,lastClickY:r,lastClickTime:Date.now()},geometry:{type:Ke,points:[{x:n,y:r}]}};let o=Date.now()-(e.selection?.lastClickTime||0),s=e.selection?.lastClickX??n,c=e.selection?.lastClickY??r;return o<Je&&Xe({x:n,y:r},{x:s,y:c})<Ye&&a.length>=3||a.length>=3&&Xe({x:n,y:r},a[0])<qe?et(e):a.length>=50?a.length>=3?et(e):e:{...e,selection:{...e.selection,mode:`COLLECTING_POINTS`,lastClickX:n,lastClickY:r,lastClickTime:Date.now()},geometry:{...e.geometry,type:Ke,points:[...a,{x:n,y:r}]}}},onMouseMove(e,t){if(e.selection?.mode!==`COLLECTING_POINTS`)return e;let{x:n,y:r}=m(t);return n==null?e:{...e,selection:{...e.selection,cursorX:n,cursorY:r}}}},MAX_POINTS:50},Z={disableAnnotation:!1,disableSelector:!1,disableEditor:!1,disableOverlay:!1,showOverlayOnce:!1,disableContent:!1,disableHitTesting:!1,allowTouch:!1,type:G.TYPE,selectors:[G,q,Y,X],activeAnnotationComparator:(e,t)=>e===t,enableEditing:!1,onAnnotationsChange:()=>{process.env.NODE_ENV!==`production`&&console.warn(`onAnnotationsChange not provided. Annotation editing will not persist changes. Please provide an onAnnotationsChange prop to handle annotation updates.`)},renderSelector:({annotation:e})=>{switch(e.geometry?.type){case G.TYPE:return(0,u.jsx)(me,{annotation:e});case q.TYPE:return(0,u.jsx)(w,{annotation:e});case Y.TYPE:return(0,u.jsx)(k,{annotation:e});case X.TYPE:return(0,u.jsx)(M,{annotation:e});default:return null}},renderEditor:({annotation:e,onChange:t,onSubmit:n})=>(0,u.jsx)(fe,{annotation:e,onChange:t,onSubmit:n}),renderHighlight:({key:e,annotation:t,active:n})=>{switch(t.geometry.type){case G.TYPE:return(0,u.jsx)(he,{annotation:t,active:n},e);case q.TYPE:return(0,u.jsx)(w,{annotation:t},e);case Y.TYPE:return(0,u.jsx)(k,{annotation:t,active:n},e);case X.TYPE:return(0,u.jsx)(M,{annotation:t,active:n},e);default:return null}},renderContent:({key:e,annotation:t})=>(0,u.jsx)(P,{annotation:t},e),renderOverlay:({type:e,annotation:t}=le)=>{switch(e){case q.TYPE:return(0,u.jsx)(F,{children:`Click to Annotate`});case X.TYPE:return(0,u.jsx)(F,{children:`Click to add points · Double-click or click first point to finish · Esc to cancel`});default:return(0,u.jsx)(F,{children:`Click and Drag to Annotate`})}},renderDraggableHighlight:({key:e,annotation:t,active:n,isHovered:r,isDragging:i,hasPendingChanges:a,onDotDragStart:o,onDotDrag:s,onMoveStart:c,onMove:l,onDragEnd:d,enableRemoval:f,onRemoveAnnotation:p,onConfirm:m,onReset:h,onDeleteControlMouseEnter:g,onDeleteControlMouseLeave:_})=>{if(!r&&!i&&!a)switch(t.geometry.type){case G.TYPE:return(0,u.jsx)(he,{annotation:t,active:n},e);case q.TYPE:return(0,u.jsx)(w,{annotation:t},e);case Y.TYPE:return(0,u.jsx)(k,{annotation:t,active:n},e);case X.TYPE:return(0,u.jsx)(M,{annotation:t,active:n},e);default:return null}if(t.geometry.type===G.TYPE)return(0,u.jsx)(De,{annotation:t,active:n,isHovered:r,isDragging:i,hasPendingChanges:a,onDotDragStart:o,onDotDrag:s,onMoveStart:c,onMove:l,onDragEnd:d,enableRemoval:f,onRemoveAnnotation:p,onConfirm:m,onReset:h,onDeleteControlMouseEnter:g,onDeleteControlMouseLeave:_},`${e}-editor`);switch(t.geometry.type){case q.TYPE:return(0,u.jsx)(w,{annotation:t},e);case Y.TYPE:return(0,u.jsx)(k,{annotation:t,active:n},e);case X.TYPE:return(0,u.jsx)(M,{annotation:t,active:n},e);default:return null}}},Q=8,tt=6;function nt(e){return!!e&&typeof e.x==`number`&&typeof e.y==`number`&&typeof e.width==`number`&&typeof e.height==`number`}function rt({placement:e,geometry:t,containerHeight:n,overlayHeight:r,offsetPx:i}){if(e===`above`)return`above`;if(e===`below`)return`below`;let a=t.y/100*n,o=(t.y+t.height)/100*n,s=r+i+Q,c=n-o,l=a;return c>=s?`below`:l>=s||l>=c?`above`:`below`}function $({annotation:e,containerRef:t,placement:n=`auto`,offsetPx:r=tt,className:i,style:a,children:o}){let s=(0,c.useRef)(null),[l,d]=(0,c.useState)({x:0,y:0}),[f,p]=(0,c.useState)(n===`above`?`above`:`below`),{geometry:m}=e;return(0,c.useLayoutEffect)(()=>{let e=s.current,i=t.current;if(!e||!i||!nt(m))return;let a=i.getBoundingClientRect(),o=e.offsetHeight,c=rt({placement:n,geometry:m,containerHeight:a.height,overlayHeight:o,offsetPx:r});if(c!==f){p(c);return}let l=e.getBoundingClientRect(),u=0;l.right>a.right-Q&&(u=a.right-Q-l.right),l.left+u<a.left+Q&&(u=a.left+Q-l.left);let h=0;l.bottom>a.bottom-Q&&(h=a.bottom-Q-l.bottom),l.top+h<a.top+Q&&(h=a.top+Q-l.top),d(e=>e.x===u&&e.y===h?e:{x:u,y:h})},[m,t,n,r,f]),nt(m)?(0,u.jsx)(`div`,{ref:s,className:i,style:{...f===`above`?{position:`absolute`,left:`${m.x}%`,bottom:`calc(${100-m.y}% + ${r}px)`,transform:`translate(${l.x}px, ${l.y}px)`,pointerEvents:`none`,zIndex:25}:{position:`absolute`,left:`${m.x}%`,top:`calc(${m.y+m.height}% + ${r}px)`,transform:`translate(${l.x}px, ${l.y}px)`,pointerEvents:`none`,zIndex:25},...a},"data-annotation-content-anchor":!0,"data-placement":f,children:o}):null}var it=l.default.div`
  position: absolute;
  pointer-events: auto;
  z-index: 10;
  width: ${24}px;
