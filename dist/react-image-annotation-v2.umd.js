...
`,M=({onChange:e,onSubmit:n,onFocus:r,onBlur:i,value:a})=>{let o=t.default.useRef(null);return t.default.useEffect(()=>{o.current?.focus({preventScroll:!0})},[]),(0,D.jsxs)(t.default.Fragment,{children:[(0,D.jsx)(A,{children:(0,D.jsx)(`textarea`,{ref:o,placeholder:`Write description`,onFocus:r,onBlur:i,onChange:e,value:a})}),a&&(0,D.jsx)(j,{onClick:n,children:`Submit`})]})},N={},P={},F=n.keyframes`
  from {
    opacity: 0;
    transform: scale(0);
  }
...
`,I=16,L=n.default.div`
  ...
  overflow: hidden;
`,R=({annotation:e,onChange:n,onSubmit:r,className:i=``,style:a=N})=>{let{geometry:o}=e,s=t.default.useRef(null),[c,l]=t.default.useState(`below`);if(t.default.useLayoutEffect(()=>{let e=s.current,t=e?.parentElement;if(!e||!t||!o)return;let n=t.getBoundingClientRect(),r=e.offsetHeight;l(((o.y??0)+(o.height??0))/100*n.height+I+r>n.height?`above`:`below`)},[o,e.data?.text]),!o)return null;let u=c===`above`?{bottom:`calc(${100-(o.y??0)}% + ${I}px)`}:{top:`calc(${(o.y??0)+(o.height??0)}% + ${I}px)`};return(0,D.jsx)(L,{ref:s,className:i,$placement:c,style:{position:`absolute`,left:`${o.x??0}%`,...u,...a},children:(0,D.jsx)(M,{onChange:t=>n({...e,data:{...e.data,text:t.target.value}}),onSubmit:r,value:e.data?.text})})},z=n.default.div`
...
`,B=n.default.div`
  ...
  bottom: 0;
  right: 0;
`;function V({annotation:e,className:t=``,style:n=N}){let{geometry:r}=e;return r?(0,D.jsxs)(B,{className:t,style:n,children:[(0,D.jsx)(z,{style:{height:`${r.y}%`,width:`100%`}}),(0,D.jsx)(z,{style:{top:`${r.y}%`,height:`${r.height}%`,width:`${r.x}%`}}),(0,D.jsx)(z,{style:{top:`${r.y}%`,left:`${r.x+r.width}%`,height:`${r.height}%`,width:`${100-(r.x+r.width)}%`}}),(0,D.jsx)(z,{style:{top:`${r.y+r.height}%`,height:`${100-(r.y+r.height)}%`,width:`100%`}})]}):null}var H=n.default.div`
  border: dashed 2px black;
  box-shadow: 0px 0px 1px 1px white inset;
  box-sizing: border-box;
  transition: box-shadow 0.21s ease-in-out;
`;function U({annotation:e,className:t=``,style:n=N,active:r}){let{geometry:i}=e;return i?(0,D.jsx)(H,{className:t,style:{position:`absolute`,left:`${i.x}%`,top:`${i.y}%`,height:`${i.height}%`,width:`${i.width}%`,boxShadow:r?`0 0 1px 1px yellow inset`:void 0,...n}}):null}var W=n.default.div`
  border: dashed 2px black;
  border-radius: 100%;
  box-shadow: 0px 0px 1px 1px white inset;
  box-sizing: border-box;
  transition: box-shadow 0.21s ease-in-out;
`;function G({annotation:e,className:t=``,style:n=N,active:r}){let{geometry:i}=e;return i?(0,D.jsx)(W,{className:t,style:{position:`absolute`,left:`${i.x}%`,top:`${i.y}%`,height:`${i.height}%`,width:`${i.width}%`,boxShadow:r?`0 0 1px 1px yellow inset`:void 0,...n}}):null}var ee=n.default.div`
  background: white;
  border-radius: 2px;
  box-shadow:
    0px 1px 5px 0px rgba(0, 0, 0, 0.2),
  ...
  margin-top: 8px;
  margin-left: 8px;
`;function te({annotation:e,style:t=N,className:n=``}){let{geometry:r}=e;return!r||r.x===void 0||r.y===void 0||r.width===void 0||r.height===void 0?null:(0,D.jsx)(ee,{style:{position:`absolute`,left:`${r.x}%`,top:`${r.y+r.height}%`,...t},className:n,children:e.data&&e.data.text})}var K=n.default.div`
  ...
  user-select: none;
`,q=`RECTANGLE`;function ne({x:e,y:t},n,r){if(!n)return!1;let i=Math.min(n.x,n.x+n.width),a=Math.max(n.x,n.x+n.width),o=Math.min(n.y,n.y+n.height),s=Math.max(n.y,n.y+n.height);return!(e<i||t<o||e>a||t>s)}function re(e,t){return!e||e.width<=0||e.height<=0?0:Math.abs(e.width)*Math.abs(e.height)}var ie={onTouchStart(e,t){return ae(e,t)},onTouchEnd(e,t){return J(e,t)},onTouchMove(e,t){return oe(e,t)},onMouseDown(e,t){return ae(e,t)},onMouseUp(e,t){return J(e,t)},onMouseMove(e,t){return oe(e,t)}};function ae(e,t){if(e.selection)return{};{let{x:n,y:r}=h(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}}function J(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function oe(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=h(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:q,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var Y={TYPE:q,intersects:ne,area:re,methods:ie},se=6,ce=(e={width:100,height:100})=>({marginX:se/e.width*100,marginY:se/e.height*100}),le=`POINT`;function ue({x:e,y:t},n,r){if(!n)return!1;let{marginX:i,marginY:a}=ce(r),o=Math.min(i,a)/2,s=Math.abs(e-n.x),c=Math.abs(t-n.y);return s<=o&&c<=o}function de(e,t){return 0}var X={TYPE:le,intersects:ue,area:de,methods:{onClick(e,t){return e.geometry?{}:{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`},geometry:{...e.geometry,...h(t),width:0,height:0,type:le}}}}},Z=e=>e**2,fe=`OVAL`;function pe({x:e,y:t},n,r){if(!n||!n.width||!n.height)return!1;let i=Math.abs(n.width),a=Math.abs(n.height),o={x:n.x+i/2,y:n.y+a/2},s=i/2,c=a/2;if(s===0||c===0)return!1;let l=e-o.x,u=t-o.y;return Z(l)/Z(s)+Z(u)/Z(c)<=1}function me(e,t){if(!e||e.width<=0||e.height<=0)return 0;let n=Math.abs(e.width),r=Math.abs(e.height);return n/2*Math.PI*(r/2)}var he={onTouchStart(e,t){return ge(e,t)},onTouchEnd(e,t){return _e(e,t)},onTouchMove(e,t){return ve(e,t)},onMouseDown(e,t){if(!e.geometry){let{x:n,y:r}=h(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e},onMouseUp(e,t){if(e.selection&&e.selection.mode===`SELECTING`)return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}}},onMouseMove(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=h(t);return{...e,geometry:{...e.geometry,type:fe,x:Math.min(n,i),y:Math.min(r,a),width:Math.abs(i-n),height:Math.abs(a-r)}}}return e}};function ge(e,t){if(e.selection)return{};{let{x:n,y:r}=h(t);return{...e,selection:{...e.selection,mode:`SELECTING`,anchorX:n,anchorY:r}}}return e}function _e(e,t){if(e.selection){let{selection:t,geometry:n}=e;if(!n)return{};switch(e.selection.mode){case`SELECTING`:return{...e,selection:{...e.selection,showEditor:!0,mode:`EDITING`}};default:break}}return e}function ve(e,t){if(e.selection&&e.selection.mode===`SELECTING`){let{anchorX:n,anchorY:r}=e.selection,{x:i,y:a}=h(t),o=i-n,s=a-r;return{...e,geometry:{...e.geometry,type:fe,x:o>0?n:i,y:s>0?r:a,width:Math.abs(o),height:Math.abs(s)}}}return e}var Q={TYPE:fe,intersects:pe,area:me,methods:he},$={disableAnnotation:!1,disableSelector:!1,disableEditor:!1,disableOverlay:!1,allowTouch:!1,type:Y.TYPE,selectors:[Y,X,Q],activeAnnotationComparator:(e,t)=>e===t,enableEditing:!1,onAnnotationsChange:()=>{process.env.NODE_ENV!==`production`&&console.warn(`onAnnotationsChange not provided. Annotation editing will not persist changes. Please provide an onAnnotationsChange prop to handle annotation updates.`)},renderSelector:({annotation:e})=>{switch(e.geometry?.type){case Y.TYPE:return(0,D.jsx)(V,{annotation:e});case X.TYPE:return(0,D.jsx)(k,{annotation:e});case Q.TYPE:return(0,D.jsx)(G,{annotation:e});default:return null}},renderEditor:({annotation:e,onChange:t,onSubmit:n})=>(0,D.jsx)(R,{annotation:e,onChange:t,onSubmit:n}),renderHighlight:({key:e,annotation:t,active:n})=>{switch(t.geometry.type){case Y.TYPE:return(0,D.jsx)(U,{annotation:t,active:n},e);case X.TYPE:return(0,D.jsx)(k,{annotation:t},e);case Q.TYPE:return(0,D.jsx)(G,{annotation:t,active:n},e);default:return null}},renderContent:({key:e,annotation:t})=>(0,D.jsx)(te,{annotation:t},e),renderOverlay:({type:e,annotation:t}=P)=>{switch(e){case X.TYPE:return(0,D.jsx)(K,{children:`Click to Annotate`});default:return(0,D.jsx)(K,{children:`Click and Drag to Annotate`})}}},ye=n.default.div`
  clear: both;
  position: relative;
  width: 100%;
...
`,Se=n.default.div`
  ...
  bottom: 0;
  right: 0;
`;function Ce({setContainerRef:e,style:n,className:r,onContainerMouseLeave:i,onContainerTouchCancel:a,onContainerMouseMove:o,allowTouch:s,setImageRef:c,src:l,alt:u,annotations:d,renderSlots:f,shouldAnnotationBeActive:p,topAnnotationAtMouse:m,disableSelector:h,value:g,setTargetRef:_,onInteractionTargetClick:v,onInteractionTargetMouseUp:y,onInteractionTargetMouseDown:b,disableOverlay:x,effectiveType:S,editModeAnnotationIds:C,disableEditor:w,onChange:T,onEditorSubmit:E,children:O}){let{renderHighlight:k,renderSelector:A,renderOverlay:j,renderContent:M,renderEditor:N}=f;return(0,D.jsxs)(ye,{ref:e,style:n,className:r,onMouseLeave:i,onTouchCancel:a,onMouseMove:o,$allowTouch:s,children:[(0,D.jsx)(be,{ref:c,src:l,alt:u}),(0,D.jsxs)(xe,{children:[d.map(e=>{if(!e.data?.id)return null;let n=p(e,m);return k?(0,D.jsx)(t.default.Fragment,{children:k({key:e.data.id,annotation:e,active:n})},e.data.id):null}),!h&&g?.geometry&&A&&A({annotation:g})]}),(0,D.jsx)(Se,{ref:_,"data-testid":`annotation-target`,onClick:v,onMouseUp:y,onMouseDown:b}),!x&&j&&j({type:S,annotation:g}),d.map(e=>{if(!e.data?.id)return null;let n=C?.includes(e.data.id)||!1;return(p(e,m)||n)&&M!=null?(0,D.jsx)(t.default.Fragment,{children:M({key:e.data.id,annotation:e})},e.data.id):null}),!w&&g?.selection?.showEditor&&N&&T&&N({annotation:g,onChange:T,onSubmit:E}),O]})}function we({ref:e,...n}){let{children:r,...i}=(0,t.useMemo)(()=>{let{renderSlots:e,...t}=n;return{...$,...t,selectors:t.selectors??$.selectors,renderSelector:t.renderSelector??e?.renderSelector??$.renderSelector,renderEditor:t.renderEditor??e?.renderEditor??$.renderEditor,renderHighlight:t.renderHighlight??e?.renderHighlight??$.renderHighlight,renderContent:t.renderContent??e?.renderContent??$.renderContent,renderOverlay:t.renderOverlay??e?.renderOverlay??$.renderOverlay,renderDraggableHighlight:t.renderDraggableHighlight??e?.renderDraggableHighlight??$.renderDraggableHighlight}},[n]);return(0,D.jsx)(Ce,{...w(i,e),children:r})}we.displayName=`Annotation`;function Te(e,t){if(!e||typeof e.getBoundingClientRect!=`function`)return!1;let{pageX:n,pageY:r}=t,{left:i,right:a,bottom:o,top:s}=e.getBoundingClientRect();return n>i&&n<a&&r>s&&r<o}function Ee(){let[e,n]=(0,t.useState)(!1),r=(0,t.useRef)(null);return(0,t.useEffect)(()=>{let e=e=>{let t=r.current;n(Te(t,{pageX:e.pageX,pageY:e.pageY}))};return document.addEventListener(`mousemove`,e,{passive:!0}),()=>{document.removeEventListener(`mousemove`,e)}},[]),{isHoveringOver:e,setRef:(0,t.useCallback)(e=>{r.current=e},[])}}var De=we;e.Annotation=we,e.OvalSelector=Q,e.PointSelector=X,e.RectangleSelector=Y,e.default=De,e.useAnnotationHitDetection=b,e.useMouseHover=Ee,e.useRelativeMousePosition=y,e.useSelectorMethods=S});